...
<div id="formulaire-ins-titre"><h4>Pour vous inscrire, remplissez ce formulaire:</h4></div>
  ...
  <form method="post" action="traitement.php" class="form_redirection">
    <p>
              ...
              <input type="text" name="prenom" id="prenom" class="champ-input_redirection" class="champ" placeholder="Ex : Guillaume" size="30" maxlength="10" />
              <br />
              <br />
              <label for="nom" class="label_redirection">Nom :</label>
              <input type="text" name="nom" id="nom" class="champ-input_redirection" class="champ" placeholder="Ex : MOREL" size="30" maxlength="10" />
              <br />
              <br />
              <label for="adresse" class="label_redirection">Adresse :</label>
              <input type="text" name="adresse" id="adresse" class="champ-input_redirection" class="champ"size="30" placeholder="Ex :2 bis rue du long des bois"/>
              <br />
              <br />
              <label for="codepost" class="label_redirection"> Code postal :</label>
              <input type="number" name="codepost" id="codepost" class="champ-input_redirection" class="champ" placeholder="Ex : 78690" min="10000" max="96000"/>
              <br />
              <br />
              <label for="ville" class="label_redirection">  Ville :</label>
              <input type="text" name="ville" id="ville" class="champ-input_redirection" class="champ" placeholder="Ex :Saint-Louis "  size="30" />
              <br />
              <br />
              <label for="mail" class="label_redirection"> Email :</label>
              <input type="email" name="mail" id="mail" class="champ-input_redirection" class="champ" size="30" placeholder="Ex :azerty@gmail.com  " />
              <br />
              <br />
              <label for="tel" class="label_redirection" class="grand"> Numero de telephone :</label>
              <input type="tel" name="tel" id="tel" class="champ-input_redirection" class="champ" maxlength="10" minlength="10"/>
              <br />
              <br />
              <label for="pass" class="label_redirection" class="grand"> Mot de passe :</label>
              <input type="password" name="pass" id="pass" class="champ-input_redirection" class="champ" minlength="6" />
              <br />
              <br />
              <label for="passverif" class="label_redirection" class="grand">Confirmez votre mot de passe :</label>
              <input type="password" name="passverif" id="passverif" class="champ-input_redirection" class="champ" minlength="6"/>
              <br />
              <br />
              <br />
        ...
        <div class="valider">
          ...
          <br />
          <input class="validation-ins_redirection" class="validation" type="submit" name="valider" value="Valider l'inscription" />
          <input class="validation-ins_redirection" type="reset" class="rafraichir" value="Rafraîchir" />
        </div>
    </p>
  </form>
</div>
  ...
  <div class="formulaire-co_redirection">
      ...
      <p>
          ...
          <div id="validation-co">
            <input type="submit" name="valider" value="Connexion" class="champ-input_redirection" class="validation"/>
          </div>
      </p>
      </form>
  </div> 
